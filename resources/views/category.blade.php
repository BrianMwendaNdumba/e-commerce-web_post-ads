                    ...
                    <div class="col-xxl-9 col-xl-9 col-lg-8 col-md-7">
                        ...
                        <div class="gridView customTab-content customTab-content-1 active">
                            ...
                            <div class="mb-20 category_title">
                                <h1>Top <span class="category_name">{{ $category->title }}</span> Ads
                                    <span class="category_count">({{ count($category->listing) }} items)</span>
                                </h1>
                            </div>

                            <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3">

                                @forelse ($category->listing as $listing)
                                    <div class="col">
